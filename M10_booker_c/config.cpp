...
class CfgVehicles
{
	...
	class B_LT_M10: LT_M10_base
	{
		...
		displayName="M10 Booker";
		author="[CN]Lurker1011,真红战队";
		editorPreview="\M10_booker\tex\ui\m10_booker_pre.jpg";
		class SimpleObject
		{
			eden=1;
			animate[]=
...
class CfgMagazines
{
	class 20Rnd_M900_APFSDS: VehicleMagazine
	{
		author="[CN]Lurker1011";
		displayName="M900 105mm APFSDS";
		displayNameShort="M900 APFSDS";
		ammo="rhs_ammo_M900";
		initSpeed=1575;
		count=20;
		maxLeadSpeed=25;
	...
	class 20Rnd_m900a1_APFSDS: rhs_mag_M829A2
	{
		count = 20;
		initSpeed = 1575;
		author="[CN]Lurker1011,真红战队";
		displayName="M900A1 105mm APFSDS";
		displayNameShort="M900A1 APFSDS";
        descriptionShort = "APFSDS-T M900A1";
		muzzleImpulseFactor[] = {0.5,4};
		tracersEvery = 1;
	};
	class 8Rnd_m494_APERS: VehicleMagazine
	{
		author="[CN]Lurker1011";
		scope=2;
		displayName="M494 105mm APERS";
		displayNameShort="M494 APERS";
		ammo="rhs_ammo_M494";
		count=8;
		initSpeed=821;
		maxLeadSpeed=25;
	...
	class 12Rnd_M456A2_HEAT: VehicleMagazine
	{
		author="[CN]Lurker1011";
		scope=2;
		displayName="M456A2 105mm HEAT";
		displayNameShort="M456A2 HEAT";
	...
	class 8Rnd_M393A3_HE: VehicleMagazine
	{
		author="[CN]Lurker1011";
		scope=2;
		displayName="M393A3 105mm HE";
		displayNameShort="M393A3 HE";
...
class CfgWeapons
{
	class lk_weap_xm35: rhs_weap_m256
	{
		ballisticsComputer = "2 + 16";
		displayname="105mm M35";
		magazines[]=
		{
			"20Rnd_M900_APFSDS",
			"20Rnd_m900a1_APFSDS",
