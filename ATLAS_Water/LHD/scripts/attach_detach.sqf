...
if(_direction == "up")then
{
	...
	if((_attached_veh distance (_veh modeltoworld [(_veh selectionposition 'hook_1')select 0,(_veh selectionposition 'hook_1')select 1,(_veh selectionposition 'hook_1')select 2])) > 10)exitwith{_veh animate [_animpart,0];};
