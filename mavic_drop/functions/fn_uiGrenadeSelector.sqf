...
private _allowedGrenades = missionNamespace getVariable ["Mavic_allowedGrenades", ["mavick_M67", "mavick_V40", "Mavic_F1", "Mavic_Vog25", "Mavic_tbg", "Mavic_M433"]];
...
for "_i" from 0 to _count - 1 do {
    ...
    _pictureButton setVariable ["mavic_ui_allData", [_actionInfo, _newGrenade, _display]];
